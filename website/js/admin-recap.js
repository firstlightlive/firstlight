...
(function() {
 ...
 fetch(url, { headers: { 'apikey': KEY, 'Authorization': 'Bearer ' + KEY } }).then(function(r) { return r.json(); }).then(function(data) { cb(null, data); }).catch(function(e) { cb(e, []); });
 }
 ...
 publishToIG(previewPost, caption, 'weekly_recap').then(function(mediaId) {
 ...
 uploadCanvasToStorage(previewStory, storyFilename).then(function(publicUrl) {
